...
declare const ThemeProvider: {
    ({ children, defaultColorMode, }: ThemeProviderProps): react_jsx_runtime.JSX.Element;
    displayName: string;
};

declare function useColorMode(): ThemeContextValue;
...
declare const ThemeToggle: {
    ({ mode, className }: ThemeToggleProps): react_jsx_runtime.JSX.Element;
    displayName: string;
};

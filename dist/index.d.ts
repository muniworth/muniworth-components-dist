...
interface UtilityValues {
	...
	colorPalette: "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "violet" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "brand.blue" | "brand.red" | "brand.dark" | "neutral.dark" | "neutral.medium" | "neutral.base" | "neutral.blue" | "neutral.light" | "data.navy" | "data.red" | "data.blue" | "data.orange" | "data.purple-dark" | "data.yellow" | "data.purple" | "data.green" | "bg.base" | "bg.subtle" | "bg.elevated" | "border.subtle" | "border.strong" | "state.info" | "state.success" | "state.warning" | "state.danger" | "text.main" | "text.subtle" | "text.on-dark" | "text.link" | "text.link-hover" | "accent.primary" | "accent.secondary" | "accent.dark" | "text.primary" | "text.secondary" | "text.linkHover" | "background.base" | "background.subtle" | "background.elevated" | "button.primary.bg" | "button.primary.bgHover" | "button.primary.text" | "button.secondary.bg" | "button.secondary.bgHover" | "button.secondary.border" | "button.secondary.text" | "button.danger.bg" | "button.danger.bgHover" | "button.danger.text" | "alert.info.bg" | "alert.info.border" | "alert.info.text" | "alert.success.bg" | "alert.success.border" | "alert.success.text" | "alert.warning.bg" | "alert.warning.border" | "alert.warning.text" | "alert.danger.bg" | "alert.danger.border" | "alert.danger.text" | "toast.bg" | "toast.text" | "toast.border" | "toast.closeHover" | "progress.bg" | "progress.fill" | "spinner.color" | "tabs.active.border" | "tabs.active.text" | "tabs.inactive.text" | "tabs.hover.bg" | "accordion.trigger.hover" | "accordion.content.bg" | "popover.bg" | "popover.border" | "tooltip.bg" | "tooltip.text" | "overlay.modal" | "selection.bg";
...
type SlotRecipeVariantFn<S extends string, T extends RecipeVariantRecord> = (
...
declare const spinnerRecipe: RecipeRuntimeFn<{
    size: {
        sm: {
...
type SpinnerProps = Omit<HTMLAttributes<HTMLDivElement>, 'children'> & SpinnerVariants & {
    label?: string;
};
declare const Spinner: react.ForwardRefExoticComponent<Omit<HTMLAttributes<HTMLDivElement>, "children"> & {
    size?: "sm" | "md" | "lg" | undefined;
} & {
    label?: string;
} & react.RefAttributes<HTMLDivElement>>;

declare const FormContainer: StyledComponent<"div", {}>;
type FormContainerProps = ComponentProps$1<typeof FormContainer>;
declare const FormLabel: StyledComponent<"label", {}>;
type FormLabelProps = ComponentProps$1<typeof FormLabel>;
declare const FormHelperText: StyledComponent<"span", {
    isError?: boolean | undefined;
}>;
type FormHelperTextProps = ComponentProps$1<typeof FormHelperText> & {
    isError?: boolean;
};
declare const FormItemContainer: StyledComponent<"div", {}>;
type FormItemContainerProps = ComponentProps$1<typeof FormItemContainer>;

type IconName = 'chevron-left' | 'chevron-right' | 'chevron-down' | 'chevron-up' | 'angles-left' | 'angles-right' | 'arrow-up' | 'arrow-down' | 'xmark' | 'check' | 'plus' | 'minus' | 'circle-info' | 'circle-check' | 'triangle-exclamation' | 'circle-exclamation';
...
declare const Icon: {
    ({ name, size, className, style }: IconProps): react_jsx_runtime.JSX.Element;
    displayName: string;
};
...
declare const CardActions: StyledComponent<"div", {}>;
...
declare const ToastProvider: ({ children, label, duration, swipeThreshold }: ToastProviderProps) => react_jsx_runtime.JSX.Element;
...
declare const Table: <TData>(props: TableProps<TData> & {
